...
const InterState = (props) => {
 ...
 const [formData, setFormData] = useState({
  ...
  const {countryId,pickupCity,deliveryCity,stateId,cityId,budget,description,pickup_address,delivery_address,errors,confirmId,registrationStatus,payment_type,item,number_of_vehicle,vehicle_capacity,vehicle_type_id} = formData;
  ...
  params.append('type', "inter-state");
          ...
          <div className="card card-body">
              <div className="row g-4">
                ...
                <div className="col-md-12">
                   ...
                   <div className="pc fs-24 fw-700 pb-4">Inter-State Booking Form</div>
                   ...
                   {/*<div className="form-group col-md-6">
                    ...
                    <div className="form-group col-md-6">
                        <label for="about-us" className="form-label">Pickup City</label>
                        <select class="form-select" onChange={(e) => setFormData({...formData, pickupCity: e.target.value})}>
                          <option selected>Select City</option>
                          {currentLocation.length == 0  ? null : currentLocation.cities.map((item) => <option value={item.id} key={item.id}>{item.name}</option> )}
                        </select>
                        {errors.pickup_city != undefined ? <span className="fs-12 text-danger">{errors.pickup_city[0]}</span> : null}
                    </div>

                    <div className="form-group col-md-6">
                        <label for="about-us" className="form-label">Delivery City</label>
                        <select class="form-select" onChange={(e) => setFormData({...formData, deliveryCity: e.target.value})}>
                          <option selected>Select City</option>
                          {currentLocation.length == 0 ? null : currentLocation.cities.map((item) => <option value={item.id} key={item.id}>{item.name}</option> )}
                        </select>
                        {errors.delivery_city != undefined ? <span className="fs-12 text-danger">{errors.delivery_city[0]}</span> : null}
                    </div>
                    ...
                    <div className="form-group col-md-6">
                        <label for="budget" className="form-label">Delivery Address</label>
...
*/}
                   <div className="form-group col-md-6">
                    ...
                    <div className="form-group" >
                        <button className="rounded-pill btn-lg btn btn-primary text-white fs-14 px-4" type="submit">Post Job Request</button>
                    </div>
