...
const Edit = (props) => {
  ...
  params.append('type', reuseData.type);
  ...
  axios({
  method: "PATCH",
  url: `/transaction/job/contractor/${reuseData.id}/update`,
  data: params
  }).then((res) => {
     if(res.data.status == "success"){

       toast.success("Job has been updated successfully",{theme: "colored"}); 
          ...
          <div className="card card-body">
              <div className="row g-4">
                <div className="col-md-12">
                    <div className="pc fs-24 fw-700 py-3">Edit a Job </div>         
                ...
                <div className="col-md-12">
                   ...
                   {/*<div className="form-group col-md-6">
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <input type="text" className="form-control form-control-lg" id="budget" defaultValue={reuseData.budget} placeholder="Enter your Budget" onChange={(e) => setFormData({...formData, budget: e.target.value})}/>
                     ...
                     <div className="form-group col-md-6">
                        ...
                        <input type="text" className="form-control form-control-lg" id="item"  defaultValue={reuseData.item} placeholder="What are you moving?" onChange={(e) => setFormData({...formData, item: e.target.value})}/>
                     ...
                     <div className="form-group col-md-6">
                        ...
                        <input type="text" className="form-control form-control-lg" id="budget" defaultValue={reuseData.pickup_address} placeholder="Enter Location" onChange={(e) => setFormData({...formData, pickup_address: e.target.value})}/>
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <input type="text" className="form-control form-control-lg" id="budget" defaultValue={reuseData.delivery_address} placeholder="Enter Location" onChange={(e) => setFormData({...formData, delivery_address: e.target.value})}/>
                   ...
                   <div className="form-group col-md-6">
                        <label for="about-us" className="form-label">Vehicle Type</label>
                          <select class="form-select" defaultValue={reuseData.vehicle_type.id} onChange={(e) => setFormData({...formData, vehicle_type_id: e.target.value})} >
                     ...
                     <div className="form-group col-md-6">
                        ...
                        <select class="form-select"  defaultValue={reuseData.payment_type} onChange={(e) => setFormData({...formData, payment_type: e.target.value})}>
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <select class="form-select"  defaultValue={reuseData.number_of_vehicle} onChange={(e) => setFormData({...formData, number_of_vehicle: e.target.value})}>
                          <option>Choose number of truck</option>
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <select class="form-select"  defaultValue={reuseData.vehicle_capacity} onChange={(e) => setFormData({...formData, vehicle_capacity: e.target.value})}>
                     ...
                     <div className="form-group col-md-6">
                        ...
                        <input type="text" defaultValue={reuseData.description} className="form-control form-control-lg" id="description" placeholder="Describe your goals" onChange={(e) => setFormData({...formData, description: e.target.value})}/>
                    ...
                    <div className="form-group" >
                        <button className="btn-lg rounded-pill btn btn-primary text-white fs-14 px-4" type="submit">Edit Job </button>
                    </div>
