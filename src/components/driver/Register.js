...
const Register = (props) => {
 ...
 const [formData, setFormData] = useState({
  ...
  const {name,email,password,phoneNumber,countryId,stateId,vehicle_capacity,cityId,confirmPassword,selfie,govtId,selfieId,type,states,cities,countries,errors,vehiclePlateNumber,vehicleTypeId,frontViewImage,backViewImage,sideViewImage,confirmId,registrationStatus,terms} = formData;
...
useEffect(() => {
  ...
  useEffect(() => {
        ...
        if(confirmId && terms && typeof selfie == "object" && typeof govtId == "object" && typeof selfieId == "object" && typeof frontViewImage == "object" && typeof backViewImage == "object" && typeof sideViewImage == "object"){
  ...
  },[confirmId,terms,selfie,govtId,selfieId,frontViewImage,backViewImage,sideViewImage])
  ...
  params.append('vehicle_plate_number', vehiclePlateNumber);
  params.append('vehicle_type_id', vehicleTypeId);
  params.append('vehicle_capacity', vehicle_capacity);
  params.append('vehicle_front_view_image', frontViewImage);
  params.append('vehicle_back_view_image', backViewImage);
  params.append('vehicle_side_view_image', sideViewImage);
  ...
  data: params
     ...
     if(res.data.status == "success"){
         ...
         setTimeout(()=>{
                ...
                history.push("/driver/verify-account");
                toast.dismiss();
               ...
               <div className="card card-body py-5">
                       ...
                       <div className="col-6 left">
                          <div className="card card-body" role="button">
                           <small>Register as a</small>
                            ...
                            <Link to="/sub-contractor/register" className="stretched-link"/>
                          </div>
                       </div>
                  ...
                  <div className="form-group">
                   ...
                   <div className="form-group">
                      ...
                      <div className="form-group">
                        <label for="about-us" className="form-label">Vehicle Capacity</label>
                        <select class="form-select" onChange={(e) => setFormData({...formData, vehicle_capacity: e.target.value})}>
                          <option selected>Select Vehicle Capacity</option>
                         {vehicleCapacity.length === 0 ? null : vehicleCapacity.map((item) => 
                               <option value={item} key={item}>{item} Tons</option>
                            )}
                        </select>
                    ...
                    <div className="form-group">
                        ...
                        <select class="form-select" onChange={(e) => setFormData({...formData, vehicleTypeId: e.target.value})}>
                    ...
                    <div className="form-group">
                        <label for="plate-number" className="form-label">Vehicle Plate Number</label>
                        <input type="text" className="form-control form-control-lg" id="plate-number" placeholder="Enter Plate Number" onChange={(e) => setFormData({...formData, vehiclePlateNumber: e.target.value})}/>
                         {errors.vehicle_plate_number != undefined ? <span className="fs-12 text-danger">{errors.vehicle_plate_number[0]}</span> : null}
                    </div>
                    ...
                    <div className="form-group d-flex align-items-center justify-content-center" >
                        <button className="rounded-pill btn btn-lg btn-primary text-white fs-14 w-50" type="button" onClick={() => setRegSection(false)}
                        >Next</button>
                    </div>

                    <div className="d-flex align-items-center justify-content-center fs-13">
                        <span >Already have an Account?</span> <Link to="/driver/login" className="fw-600 mx-1">Login</Link>
                    </div>
               ...
               <div className="card card-body py-5">
                ...
                <h1 className="header mb-3">Upload ID/Photo</h1>
                  ...
                  <div className="row" >
                        ...
                        <div className="col-md-4" style={{border: "1px dashed #A2A2A8"}}>
                            <div  className="p-3 pt-5 d-flex flex-column justify-content-center align-items-center">
                                ...
                                <div className="fs-13 g2 mb-4 text-center">Please snap and upload a selfie of yourslef</div>
                        ...
                        <div className="col-md-4" style={{border: "1px dashed #A2A2A8"}}>
                            <div  className="p-3 pt-5 d-flex flex-column justify-content-center align-items-center">
                                ...
                                <div className="fs-13 g2 mb-4 text-center">Please upload a valid Govt. ID. Voters card, drivers licence or international passport</div>
                        ...
                        <div className="col-md-4" style={{border: "1px dashed #A2A2A8"}}>
                            <div  className="p-3 pt-5 d-flex flex-column justify-content-center align-items-center">
                                ...
                                <div className="fs-13 g2 mb-4 text-center">Please snap and upload a selfie with valid ID</div>
                        ...
                        <div className="col-md-4" style={{border: "1px dashed #A2A2A8"}}>
                            <div  className="p-3 pt-5 d-flex flex-column justify-content-center align-items-center">
                                <div style={{border: "2px solid #315A89",background:"#F6FAFF"}} className="p-3 py-2 mb-3 lh-1">
                                <img src={sideViewImage ? URL.createObjectURL(sideViewImage) : "../asset/images/folder.png"} style={{height:"30px"}} />
                                </div>
                                <div className="fs-13 g2 mb-4 text-center">Please snap and upload  vehicle side view Image</div>
                                <label className="rounded-pill btn btn-outline-secondary btn-sm px-5" role="button" for="side-view-image">Choose File </label>
                                 <input type="file" id="side-view-image" hidden onChange={(e) => setFormData({...formData, sideViewImage: e.target.files[0]})} />

                                 {errors.vehicle_side_view_image != undefined ? <span className="fs-12 text-danger">{errors.vehicle_side_view_image[0]}</span> : null}
                            </div>
                        </div>
                        ...
                        <div className="col-md-4" style={{border: "1px dashed #A2A2A8"}}>
                            <div  className="p-3 pt-5 d-flex flex-column justify-content-center align-items-center">
                                <div style={{border: "2px solid #315A89",background:"#F6FAFF"}} className="p-3 py-2 mb-3 lh-1">
                                <img src={frontViewImage ? URL.createObjectURL(frontViewImage) : "../asset/images/folder.png"} style={{height:"30px"}} />
                                </div>
                                <div className="fs-13 g2 mb-4">Please snap and upload front view of your truck/vehicle</div>
                                <label className="rounded-pill btn btn-outline-secondary btn-sm px-5" role="button" for="font-view-image">Choose File </label>
                                 <input type="file" id="font-view-image" hidden onChange={(e) => setFormData({...formData, frontViewImage: e.target.files[0]})}  />

                                 {errors.vehicle_front_view_image != undefined ? <span className="fs-12 text-danger">{errors.vehicle_front_view_image[0]}</span> : null}
                            </div>
                        </div>
                         ...
                         <div className="col-md-4" style={{border: "1px dashed #A2A2A8"}}>
                            <div  className="p-3 pt-5 d-flex flex-column justify-content-center align-items-center">
                                <div style={{border: "2px solid #315A89",background:"#F6FAFF"}} className="p-3 py-2 mb-3 lh-1">
                                <img src={backViewImage ? URL.createObjectURL(backViewImage) : "../asset/images/folder.png"} style={{height:"30px"}} />
                                </div>
                                <div className="fs-13 g2 mb-4 text-center">Please snap and upload back view of your truck/vehicle</div>
                                <label className="rounded-pill btn btn-outline-secondary btn-sm px-5" role="button" for="back-view-image">Choose File </label>
                                 <input type="file" id="back-view-image" hidden onChange={(e) => setFormData({...formData, backViewImage: e.target.files[0]})} />

                                 {errors.vehicle_back_view_image != undefined ? <span className="fs-12 text-danger">{errors.vehicle_back_view_image[0]}</span> : null}
                            </div>
                        </div>
                  ...
                  <div className="form-group  d-flex align-items-center id-confirmation mt-3 px-3">
                   ...
                   <button  onClick={() => setRegSection(true)} className="rounded-pill  btn-lg btn outline fs-14 px-5 mx-2" type="button"
                      ...
                      <button className={`rounded-pill btn-lg btn btn-primary text-white fs-14 px-5 ${registrationStatus ? 'disabled' : null}`} type="submit"
                        >Register</button>
